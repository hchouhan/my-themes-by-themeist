...
add_filter( 'enter_title_here', 'themeist_theme_enter_title_here', 10, 2 );
 ...
 * @since 0.1.0
 */
function themeist_theme_enter_title_here( $title, $post ) {

	if ( in_array( $post->post_type, array( 'themes' ) ) ) {
